/**
 * Módulo de Codebase Knowledge Graph (Interactive Canvas 2D)
 * Visualização topológica do grafo de código, clusters, métricas e inspeção de nós.
 */
...
export function initOrRefreshGraph(customRoot = null) {
